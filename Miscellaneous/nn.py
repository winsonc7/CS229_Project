...
def get_initial_params(input_size, num_hidden, num_output):
    ...
    Args:
        input_size: The size of the input JEEBench_data
...
def forward_prop(data, one_hot_labels, params):
    """
    Implement the forward layer given the JEEBench_data, labels, and params.
    ...
    Returns:
        A 3 element tuple containing:
            ...
            3. The average loss for these JEEBench_data elements
    """
    # *** START CODE HERE ***
    ...
    # print("JEEBench_data shape: ", JEEBench_data.shape)
...
def backward_prop(data, one_hot_labels, params, forward_prop_func):
    ...
    # print("batch JEEBench_data : ", JEEBench_data.shape)
...
def gradient_descent_epoch(train_data, one_hot_train_labels, learning_rate, batch_size, params, forward_prop_func, backward_prop_func):
    """
    Perform one epoch of gradient descent on the given training JEEBench_data using the provided learning rate.

    This code should update the parameters stored in params.
    It should not return anything

    Args:
        train_data: A numpy array containing the training JEEBench_data
...
def read_data_new(csv_file):
    ...
    # Assuming your JEEBench_data is stored in a CSV file named 'JEEBench_data.csv'
...
def main(plot=True):
    ...
    train_data, train_labels = read_data_new("JEEBench_data/dataset_filtered_train.csv")
    ...
    test_data, test_labels = read_data_new("JEEBench_data/dataset_filtered_test.csv")
